...
const SOURCE_PROJECT = "gcp-wow-bigw-digi-analy-prod" /* specify a value here only in case your source data sits in a project other than the default defined in workflow_settings.yaml defaultDatabase variable. You would need to grant the Dataform service account BigQuery Data Viewer and BigQuery Job User access to the dataset. */
const SOURCE_DATASET = "analytics_251812126"; /* the database containing the GA4 BigQuery exports */
const REPORTING_TIME_ZONE = "Australia/Sydney"; /* replace with your property reporting time zone, this will update the timestamp columns from UTC to your GA4 property timezone (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) */
const STAGING_DATASET = "bigw_ga4_dataform_staging";
const INTERMEDIATE_DATASET = "bigw_ga4_dataform_intermediate";
const OUTPUT_DATASET = "bigw_ga4_dataform_output";
const START_DATE = 20260501; /* data will be pulled starting this date */
